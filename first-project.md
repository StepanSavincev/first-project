...
ls
```
**10 Создать директорию(папку)**

Создать директорию(папку) для хранения файлов.
```
mkdir
```
**11 Создание структуры директорий одной командой
...
Для выполнения функции копирования файла используется команда
```
cp
```
